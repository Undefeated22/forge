        ...
        return db.transaction(async (tx) => {
            ...
            const [duplicate] = await tx
                ...
                .where(and(
                    ...
                    eq(encryptedEvidence.inputCiphertext, ciphertext)
                ))
                .limit(1);
            if (duplicate) {
            ...
            const result = await runFheComputation({ tenantId, incidentId, ciphertext, serverKeyBytes, baselineCiphertext });
...
function runFheComputation({ tenantId, incidentId, ciphertext, serverKeyBytes, baselineCiphertext }) {
